...
void operation()
{
  ...
  else if(arrowNumber == 4)
  {
    ...
    // Windows
    system("Games\\Snake\\SnakeGame.exe");
  }
  else if(arrowNumber == 3)
  {
    ...
    // Windows
    system("Games\\AimGame\\AimGame.exe");
  }
  else if(arrowNumber == 2)
  {
    ...
    // Windows
    system("Games\\TowerofHanoi\\TowerofHanoiGame.exe");
  }
  else if(arrowNumber == 1)
  {
    // Linux
    // system("xdotool geta/Game/dropDown.cpp -o dropDown -lglut -lGL -lGLU && ./dropDown");

    // Windows
    system("Games\\DropDown\\DropDrownGame.exe");
  }
  else if(arrowNumber == 0)
  {
    ...
    // Windows
    system("Games\\Mastermind\\MastermindGame.exe");
  }
}
